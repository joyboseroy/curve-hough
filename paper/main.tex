...
\paragraph{Results.} % TODO: main table (curve-EA F-measure per family and corruption level), compute table (accumulator memory and FLOPs: dense 3D vs factorized), ablations (probe set size m, top-k, pooling max vs mean, refinement stage), qualitative figure.
