...
\paragraph{Qualitative results.} % TODO: uncomment once code/make_figures.py has been run against real checkpoints (parabola_hard.pt, circle_hard.pt, ellipse_hard.pt) and the PNGs are copied into paper/figures/.
% \begin{figure}[htbp]
% \centering
...
% \caption{Stage-1 anchor accumulator (left), Stage-2 shape profile at the top peak (center), and the resulting detection against ground truth (right), for a representative parabola test image.}
